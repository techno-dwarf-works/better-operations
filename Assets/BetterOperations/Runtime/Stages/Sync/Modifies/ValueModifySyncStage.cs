...
namespace Better.Operations.Runtime.Stages
{
        ...
        where TDelegate : Delegate
    {
        ...
        protected ValueModifySyncStage(GetDelegate delegateGetter) : base(delegateGetter)
        {
        }
    }
    ...
    public class ValueModifySyncStage<TBuffer, TValue, TMember> : ValueModifySyncStage<TBuffer, TValue, TMember, ValueModifySyncStage<TBuffer, TValue, TMember>.OnModify>
        ...
        where TMember : IOperationMember
    {
        public delegate TValue OnModify(TValue sourceValue, TValue modifiedValue);

        public ValueModifySyncStage(OnModify subDelegate) : base(subDelegate)
        {
        }

        public ValueModifySyncStage(GetDelegate delegateGetter) : base(delegateGetter)
        {
        }
